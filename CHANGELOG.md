...
## v0.115.5 — 2026-09-24
- docs(guards): record the spawn cost as closed by the per-judgment memo

## v0.115.4 — 2026-09-24
- test(publication-push-guard): add the spawn-bound mutation campaign

## v0.115.3 — 2026-09-24
- fix(publication-push-guard): read aliases as git does, cap git queries
...
## v0.114.5 — 2026-09-23
- fix(git_command): enumerate heredoc readings instead of guessing one

## v0.114.4 — 2026-09-18
- fix(git-timing-guard): judge every push target, bounded
...
## v0.112.1 — 2026-09-18
- test(plan-rehearse): add the suite and its plan corpus

## v0.112.0 — 2026-09-18
- feat(plan-rehearse): add the plan rehearsal runner
