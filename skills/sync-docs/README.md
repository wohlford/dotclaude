...
Implementation of the `/sync-docs` skill. See [SKILL.md](SKILL.md) for user-facing instructions and [STYLE.md](../../STYLE.md) "Documentation Sync" for the convention this skill enforces.
